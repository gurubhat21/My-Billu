...
Generated by My Billu - Smart Billing Software''';
    ...
    return pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
      ...
      pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
        pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
          if (logo != null) _logoWidget(logo, isA5 ? 40 : 56)!,
    ...
    return pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
      ...
      pw.Container(
        ...
        child: pw.Column(children: [
          if (logo != null) ...[_logoWidget(logo, isA5 ? 40 : 56)!, pw.SizedBox(height: 6)],
  ...
  static pw.Widget _buildMinimalTemplate(Bill bill, String bName, String bAddr, String bPhone, String bGstin, bool isA5, _BankInfo bk, pw.ImageProvider? logo) {
    ...
    return pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
      ...
      pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.center, children: [
        if (logo != null) _logoWidget(logo, isA5 ? 36 : 48)!,
        pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
  ...
  static pw.Widget _buildItemsTable(Bill bill, PdfColor headerBg, PdfColor headerText, double fs) {
    final headerStyle = pw.TextStyle(fontSize: 9 * fs, fontWeight: pw.FontWeight.bold, color: headerText);
    final cellStyle = pw.TextStyle(fontSize: 9 * fs);
    final subStyle = pw.TextStyle(fontSize: 7.5 * fs, color: PdfColors.grey600, fontStyle: pw.FontStyle.italic);
    final pad = pw.EdgeInsets.symmetric(horizontal: 6 * fs, vertical: 3 * fs);
    ...
    return pw.Table(
      ...
      children: [
        ...
        pw.TableRow(
          ...
          children: ['#', 'Item', 'Price', 'Qty', 'GST%', 'GST', 'Total']
            .map((h) => pw.Padding(padding: pad, child: pw.Text(h, style: headerStyle))).toList(),
        ),
        // Data rows
        ...bill.items.asMap().entries.map((e) {
          final item = e.value;
          final hasDesc = item.description != null && item.description!.isNotEmpty;
          final hasSerial = item.serialNumber != null && item.serialNumber!.isNotEmpty;
          return pw.TableRow(children: [
            ...
            pw.Padding(padding: pad, child: pw.Column(
              ...
              children: [
                ...
                if (hasDesc) pw.Text(item.description!, style: subStyle),
                if (hasSerial) pw.Text('S/N: ${item.serialNumber}', style: subStyle),
              ],
            )),
            ...
            pw.Padding(padding: pad, child: pw.Text(_cur(item.total), style: cellStyle)),
          ]);
        }),
      ],
    );
    ...
    return pw.Container(
      ...
      child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
        ...
        pw.Container(
          ...
          child: pw.Column(children: [
            if (logo != null) ...[pw.Center(child: _logoWidget(logo, isA5 ? 40 : 50)!), pw.SizedBox(height: 4)],
            pw.Center(child: pw.Text(bName.toUpperCase(),
        ...
        pw.Table(
          ...
          children: [
            ...
            ...bill.items.asMap().entries.map((e) {
              ...
              final hasDesc = item.description != null && item.description!.isNotEmpty;
              final hasSerial = item.serialNumber != null && item.serialNumber!.isNotEmpty;
              final subStyle = pw.TextStyle(fontSize: 7 * fs, color: PdfColors.grey700, fontStyle: pw.FontStyle.italic);
              return pw.TableRow(children: [
                _tCell('${e.key + 1}', fs),
                // Particulars with description + serial
                pw.Padding(
                  padding: pw.EdgeInsets.symmetric(horizontal: 4 * fs, vertical: 2 * fs),
                  child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
