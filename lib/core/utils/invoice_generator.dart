...
class InvoiceGenerator {
      ...
      build: (context) {
        ...
        switch (template) {
          case InvoiceTemplate.modern:
            return _buildModernTemplate(bill, businessName, businessAddress, businessPhone, businessGstin, isA5, bk, logoImage, docTitle);
          case InvoiceTemplate.classic:
            return _buildClassicTemplate(bill, businessName, businessAddress, businessPhone, businessGstin, isA5, bk, logoImage, docTitle);
          case InvoiceTemplate.minimal:
            return _buildMinimalTemplate(bill, businessName, businessAddress, businessPhone, businessGstin, isA5, bk, logoImage, docTitle);
          case InvoiceTemplate.gstInvoice:
            return _buildGstInvoiceTemplate(bill, businessName, businessAddress, businessPhone, businessGstin, isA5, bk, logoImage, docTitle);
        }
      },
    ));
    return pdf.save();
  ...
  static Future<void> shareInvoice(
    ...
    if (kIsWeb) {
      await Printing.sharePdf(bytes: bytes, filename: '${fileLabel}_${bill.billNumber}.pdf');
    } else {
      final xFile = XFile.fromData(bytes, mimeType: 'application/pdf', name: '${fileLabel}_${bill.billNumber}.pdf');
...
Generated by My Billu - Smart Billing Software''';
  ...
  static pw.Widget _buildModernTemplate(Bill bill, String bName, String bAddr, String bPhone, String bGstin, bool isA5, _BankInfo bk, pw.ImageProvider? logo, String? docTitle) {
  ...
  static pw.Widget _buildClassicTemplate(Bill bill, String bName, String bAddr, String bPhone, String bGstin, bool isA5, _BankInfo bk, pw.ImageProvider? logo, String? docTitle) {
    final isQuotation = docTitle != null;
    final fs = isA5 ? 0.8 : 1.0;
    return pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
  ...
  static pw.Widget _buildMinimalTemplate(Bill bill, String bName, String bAddr, String bPhone, String bGstin, bool isA5, _BankInfo bk, pw.ImageProvider? logo, String? docTitle) {
    final isQuotation = docTitle != null;
    final fs = isA5 ? 0.8 : 1.0;
    return pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
      // Logo at top
  ...
  static pw.Widget _buildGstInvoiceTemplate(Bill bill, String bName, String bAddr, String bPhone, String bGstin, bool isA5, _BankInfo bk, pw.ImageProvider? logo, String? docTitle) {
    final isQuotation = docTitle != null;
